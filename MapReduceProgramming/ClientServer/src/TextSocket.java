...
//    }
    ...
    public void putIntegerList(LinkedList<Integer> list) throws IOException
    {
    	ObjectOutputStream objectOutput = new ObjectOutputStream(sock.getOutputStream());
    	objectOutput.writeObject(list);
    }
    
    public LinkedList<Integer> getIntegerList() throws IOException, ClassNotFoundException
    {
    	ObjectInputStream objectInput = new ObjectInputStream(sock.getInputStream());
        Object object = objectInput.readObject();
        return (LinkedList<Integer>) object;
    }
