...
public class FrmFeed extends javax.swing.JFrame implements MouseListener, MouseMotionListener {
    ...
    class MyTimerTask extends TimerTask {
        ...
        @Override
        public void run() {
            mi = (MyImage) streamVideo(parent.deviceID); //pixel image
            ...
            for (int i = 0; i < mi.img.size(); i++) { //each element of mi.img consists 1 pixel
                image[i] = (int) mi.img.get(i); //we convert that temporary image array for setRGB parameter
            }
            BufferedImage bi = new BufferedImage(mi.ww, mi.hh, BufferedImage.TYPE_INT_RGB);
            bi.setRGB(0, 0, mi.ww, mi.hh, image, 0, mi.ww); //displays pixels...start and end points...and for scannig mi.ww
    ...
    private void jBLoadNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBLoadNewActionPerformed
        ...
        timer.schedule(task, 10, 100); //start after 10 ms and difference between 2 iterations is 100ms
